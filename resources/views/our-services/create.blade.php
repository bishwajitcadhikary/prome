...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.our-services.store') }}" method="post" id="createForm" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row py-4">
                            <div class="col-md-6 mx-auto">
                                ...
                                <div class="custom-control custom-checkbox mb-3">
                                    <input class="custom-control-input" type="checkbox" id="is_accordion" name="is_accordion">
