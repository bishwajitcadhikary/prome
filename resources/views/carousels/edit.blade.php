...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.carousels.update', $carousel->id) }}" method="post" id="editForm" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row py-4">
                            ...
                            <div class="col-md-6">
                                <div class="image-area mb-3 px-2 py-2">
                                    <img id="imageResult" src="{{ asset('storage/uploads/images/'.$carousel->image) }}" alt="" class="img-fluid rounded shadow-sm mx-auto d-block">
                                </div>
                            </div>
                        </div>
